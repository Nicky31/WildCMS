...
<li><a href="<?php echo site_url('inscriptions','index'); ?>">Inscription</a></li>
...
<div class="menuc_content">
<center>
<form action="<?php echo site_url('connection','index'); ?>" method="post">
<input style="margin-left:5px;" class="login2" type="text" name="account" placeholder="Nom de compte">
<input style="margin-left:5px;" class="login2" type="password" name="pass" placeholder="********">
<input name="hidden" type="hidden" value="log">
<br><br><input style="width: 60px;" class="login2" type="submit" name="logon" value="OK">
</form>
</center>
</div>
