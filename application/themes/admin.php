...
<div class="menuc_content">
<li><a href="<?php echo site_url('admin_accounts','index'); ?>">Gestion des Comptes</a></li>
<li><a href="<?php echo site_url('boutique','admin'); ?>">Gestion boutique</a></li>
<li><a href="<?php echo site_url('news','add'); ?>">Ajouter une news</a></li>
<li><a href="<?php echo site_url('staff','edit'); ?>">Editer l'Equipe</a></li>
</div>
