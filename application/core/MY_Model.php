...
class MY_Model extends CI_Model
{
	...
	/**
	 *	InsÃ©re une nouvelle ligne dans la base de donnÃ©es.
	 */
	...
	public function delete($where)
	{
		...
		/**
		 * Vérifie l'existence d'une ligne selon $where. Renvoie true si existe, false si non existant
		 */
		public function checkExists($champ,$valeur = null)
		 {
